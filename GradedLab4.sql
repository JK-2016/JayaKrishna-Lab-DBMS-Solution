...
/*4) Display all the orders along with product name ordered by a customer
 ...
 select * from supplier inner join
...
(select ord_id, pro_id, ord_date from `order` as o
...
right join 
(select o.ord_id,rat.stars,rat.Type_Of_Service,o.pricing_id from `order` as o
right join
